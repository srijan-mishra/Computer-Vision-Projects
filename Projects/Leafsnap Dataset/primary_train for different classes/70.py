...
def train_top_model(num_neurons):
    ...
    train_labels = np.array([0] * (360) + [1] * (225) + [2] * (225) + [3] * (216) + [4] * (198) + [5] * (189) + [6] * (180) + [7] * (180) + [8] * (180) + [9] * (180) + [10] * (171) + [11] * (162) + [12] * (162) + [13] * (162) + [14] * (153) + [15] * (153) + [16] * (153) + [17] * (144) + [18] * (144) + [19] * (144) + [20] * (135) + [21] * (135) + [22] * (126) + [23] * (126) + [24] * (126) + [25] * (126) + [26] * (126) + [27] * (108) + [28] * (108) + [29] * (108) + [30] * (108) + [31] * (108) + [32] * (108) + [33] * (108) + [34] * (108) + [35] * (108) + [36] * (108) + [37] * (108) + [38] * (108) + [39] * (108) + [40] * (108) + [41] * (108) + [42] * (108) + [43] * (108) + [44] * (108) + [45] * (108) + [46] * (108) + [47] * (108) + [48] * (108) + [49] * (108) + [50] * (108) + [51] * (108) + [52] * (108) + [53] * (108) + [54] * (108) + [55] * (108) + [56] * (108) + [57] * (108) + [58] * (108) + [59] * (108) + [60] * (108) + [61] * (108) + [62] * (108) + [63] * (108) + [64] * (108) + [65] * (108) + [66] * (108) + [67] * (108) + [68] * (108) + [69] * (108))
