...
nb_train_samples = 11385
nb_validation_samples = 1265
nb_epoch = 30
#num_neurons=64
...
def train_top_model(num_neurons):
    ...
    train_labels = np.array([0] * (360) + [1] * (225) + [2] * (225) + [3] * (216) + [4] * (198) + [5] * (189) + [6] * (180) + [7] * (180) + [8] * (180) + [9] * (180) + [10] * (171) + [11] * (162) + [12] * (162) + [13] * (162) + [14] * (153) + [15] * (153) + [16] * (153) + [17] * (144) + [18] * (144) + [19] * (144) + [20] * (135) + [21] * (135) + [22] * (126) + [23] * (126) + [24] * (126) + [25] * (126) + [26] * (126) + [27] * (108) + [28] * (108) + [29] * (108) + [30] * (108) + [31] * (108) + [32] * (108) + [33] * (108) + [34] * (108) + [35] * (108) + [36] * (108) + [37] * (108) + [38] * (108) + [39] * (108) + [40] * (108) + [41] * (108) + [42] * (108) + [43] * (108) + [44] * (108) + [45] * (108) + [46] * (108) + [47] * (108) + [48] * (108) + [49] * (108) + [50] * (108) + [51] * (108) + [52] * (108) + [53] * (108) + [54] * (108) + [55] * (108) + [56] * (108) + [57] * (108) + [58] * (108) + [59] * (108) + [60] * (108) + [61] * (108) + [62] * (108) + [63] * (108) + [64] * (108) + [65] * (108) + [66] * (108) + [67] * (108) + [68] * (108) + [69] * (108) + [70] * (108) + [71] * (108) + [72] * (108) + [73] * (108) + [74] * (108) + [75] * (108) + [76] * (108) + [77] * (108) + [78] * (108) + [79] * (108) + [80] * (108) + [81] * (108) + [82] * (108) + [83] * (108) + [84] * (108) + [85] * (108) + [86] * (108) + [87] * (108) + [88] * (108) + [89] * (108))
    t_labels=to_categorical(train_labels)

    validation_data = np.load(open('bottleneck_features_validation.npy'))
    validation_labels = np.array([0] * (40) + [1] * (25) + [2] * (25) + [3] * (24) + [4] * (22) + [5] * (21) + [6] * (20) + [7] * (20) + [8] * (20) + [9] * (20) + [10] * (19) + [11] * (18) + [12] * (18) + [13] * (18) + [14] * (17) + [15] * (17) + [16] * (17) + [17] * (16) + [18] * (16) + [19] * (16) + [20] * (15) + [21] * (15) + [22] * (14) + [23] * (14) + [24] * (14) + [25] * (14) + [26] * (14) + [27] * (12) + [28] * (12) + [29] * (12) + [30] * (12) + [31] * (12) + [32] * (12) + [33] * (12) + [34] * (12) + [35] * (12) + [36] * (12) + [37] * (12) + [38] * (12) + [39] * (12) + [40] * (12) + [41] * (12) + [42] * (12) + [43] * (12) + [44] * (12) + [45] * (12) + [46] * (12) + [47] * (12) + [48] * (12) + [49] * (12) + [50] * (12) + [51] * (12) + [52] * (12) + [53] * (12) + [54] * (12) + [55] * (12) + [56] * (12) + [57] * (12) + [58] * (12) + [59] * (12) + [60] * (12) + [61] * (12) + [62] * (12) + [63] * (12) + [64] * (12) + [65] * (12) + [66] * (12) + [67] * (12) + [68] * (12) + [69] * (12) + [70] * (12) + [71] * (12) + [72] * (12) + [73] * (12) + [74] * (12) + [75] * (12) + [76] * (12) + [77] * (12) + [78] * (12) + [79] * (12) + [80] * (12) + [81] * (12) + [82] * (12) + [83] * (12) + [84] * (12) + [85] * (12) + [86] * (12) + [87] * (12) + [88] * (12) + [89] * (12))
    ...
    for i in range(ratio):
        ...
        if i<9:
            for j in range(len(index_dict)-1):
                ...
                train_data[index_dict[j-1]+i*validation_dict[j]:index_dict[j-1]+(i+1)*validation_dict[j],:,:,:]=train_data[index_dict[j-1]+i*validation_dict[j]:index_dict[j-1]+(i+1)*validation_dict[j],:,:,:]-validation_data[val_index_dict[j-1]:val_index_dict[j],:,:,:]
        model.save_weights('/Users/srijanmishra/Desktop/leafsnap/Mailed code/90 classes/weights/'+str(num_neurons)+'_'+str(i))
